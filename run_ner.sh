...
# test
python main.py --mode test --batch_size 8 --eval_steps 1000 --data_name onto4ner.cn --data_path data --learning_rate 3e-5 --num_train_epochs 10 --pytorch_dump_path saved/ontonote/saved.model_1 --data_format ontonote --chinese --output_path predict.ontonote --model_type BertForTokenClassification --num_labels 17
