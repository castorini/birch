...
experiment=$1
collection=$2  # robust04_5cv, robust04_2cv, msmarco_top1000_dev, msmarco_top1000_dev, msmarco_expanded_top1000_dev...
...
qrels_file=$4  # msmarco-docdev-qrels.tsv (placeholder for test also!)...
num_folds=$5
anserini_path=$6
