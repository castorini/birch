...
do
    ...
    cat "log/${experiment}/eval${i}a.txt" | sort -k5,5 -r | head -1 > "log/${experiment}/${i}a_best.txt"
    ...
    cat "log/${experiment}/eval${i}ab.txt" | sort -k5,5 -r | head -1 > "log/${experiment}/${i}ab_best.txt"
    rm "runs/run.${experiment}.cv.train"
    ...
    cat "log/${experiment}/eval${i}abc.txt" | sort -k5,5 -r | head -1 > "log/${experiment}/${i}abc_best.txt"
    rm "runs/run.${experiment}.cv.train"
done